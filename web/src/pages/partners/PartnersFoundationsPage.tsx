        ...
        <div className="pp-wrap">
          ...
          <div className="pp-grid">
            {[
              ...
              { I: IcGlobe, t: 'National prestige & health diplomacy', d: 'Position your country as the regional leader, convening nine EECA parliaments with support from the Global TB Caucus.' },
      ...
      <section className="pp-sec tinted">
        <div className="pp-wrap">
          ...
          <div className="pp-logos">
            <span>With support from&nbsp;<b>the Global TB Caucus</b></span>
