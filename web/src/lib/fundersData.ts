...
export const FUNDER_GROUPS: FunderGroup[] = [
  ...
  },
  {
    ...
    funders: [
      ...
      { name: 'Stop TB Partnership (CFCS)', country: 'Global', type: 'UN-hosted partnership / regrantor', focus: 'TB advocacy · communities · civil society', fit: 'High', why: 'Convenes the Global TB Caucus, which supports the Hub; CFCS Round 13 = $19M. Warmest near-term route.', route: 'stoptb.org — funding communities (CFCS)' },
