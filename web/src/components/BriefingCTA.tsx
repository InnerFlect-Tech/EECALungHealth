...
function buildMailto(lang: 'en' | 'ru'): string {
  const subject =
    lang === 'ru'
      ? 'Запрос консультации – EECA Lung Health Hub'
      : 'Consultation request – EECA Lung Health Hub';

  const body =
    lang === 'ru'
      ? 'Здравствуйте, Алесия,\n\nМы хотели бы назначить 30-минутную консультацию по EECA Lung Health Hub.\n\nОрганизация:\nИмя:\nРоль:\nУдобное время (следующие 2 недели):\n\nСпасибо.'
      : "Hello Alesia,\n\nWe'd like to schedule a 30-minute consultation on the EECA Lung Health Hub.\n\nOrganisation:\nName:\nRole:\nPreferred times (next 2 weeks):\n\nThanks.";
