...
const MECHANICS = `
          ...
          <div class="cn-diff-block">
          <p class="cn-suggestion">Suggested addition. Because the doc's figures were taken out of public materials, the document as it stands says nothing about money at all, which can read as evasive to a funder. This section carries the funding logic – phase by phase, and what Phase 1 actually covers – without publishing any numbers. The chart below shows proportions only.</p>
